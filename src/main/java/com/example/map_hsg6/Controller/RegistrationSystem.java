package com.example.map_hsg6.Controller;

import com.example.map_hsg6.Exceptions.MaxEnrollmentCourseException;
import com.example.map_hsg6.Exceptions.StudentCreditsOverflowException;
import com.example.map_hsg6.Model.Course;
import com.example.map_hsg6.Model.Person;
import com.example.map_hsg6.Model.Student;
import com.example.map_hsg6.Model.Teacher;
import com.example.map_hsg6.Repository.CourseJDBCRepo;
import com.example.map_hsg6.Repository.StudentJDBCRepo;
import com.example.map_hsg6.Repository.TeacherJDBCRepo;
...
public class RegistrationSystem {
    ...
    public  RegistrationSystem(@NotNull Connection connection){
    ...
    /**
     * this method retrieves all the students enrolled for a course in alphabetical order
